...
describe('basic', function () {
    it('http://example.com', function () {
        var hyperlink = Hyperlink.parse('http://example.com');
    ...
    it('http://example.com/path/name', function () {
        var hyperlink = Hyperlink.parse('http://example.com/path/name');
        assert.deepEqual(hyperlink, {
            protocol: 'http:',
            username: '',
            password: '',
    ...
    it('http://example.com/path/name?search=yes', function () {
        var hyperlink = Hyperlink.parse('http://example.com/path/name?search=yes');
        assert.deepEqual(hyperlink, {
            protocol: 'http:',
            username: '',
            password: '',
    ...
    it('http://example.com/path/name?search=yes#fragments', function () {
        var hyperlink = Hyperlink.parse('http://example.com/path/name?search=yes#fragments');
        assert.deepEqual(hyperlink, {
            protocol: 'http:',
            username: '',
            password: '',
    ...
    it('http://example.com:8080/path/name?search=yes#fragments', function () {
        var hyperlink = Hyperlink.parse('http://example.com:8080/path/name?search=yes#fragments');
        assert.deepEqual(hyperlink, {
            protocol: 'http:',
            username: '',
            password: '',
    ...
    it('http://user@example.com:8080/path/name?search=yes#fragments', function () {
        var hyperlink = Hyperlink.parse('http://user@example.com:8080/path/name?search=yes#fragments');
        assert.deepEqual(hyperlink, {
            protocol: 'http:',
            username: 'user',
            password: '',
    ...
    it('http://:pass@example.com:8080/path/name?search=yes#fragments', function () {
        var hyperlink = Hyperlink.parse('http://:pass@example.com:8080/path/name?search=yes#fragments');
        assert.deepEqual(hyperlink, {
            protocol: 'http:',
            username: '',
            password: 'pass',
    ...
    it('http://user:pass@example.com:8080/path/name?search=yes#fragments', function () {
        var hyperlink = Hyperlink.parse('http://user:pass@example.com:8080/path/name?search=yes#fragments');
        assert.deepEqual(hyperlink, {
            protocol: 'http:',
            username: 'user',
            password: 'pass',
    ...
    it('//user:pass@example.com:8080/path/name?search=yes#fragments', function () {
        var hyperlink = Hyperlink.parse('//user:pass@example.com:8080/path/name?search=yes#fragments');
    ...
    it('/path/name?search=yes#fragments', function () {
        var hyperlink = Hyperlink.parse('/path/name?search=yes#fragments');
