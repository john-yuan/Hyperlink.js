...
function Hyperlink(url) {
    ...
    deprecated('    The module "x-hyperlink" is deprecated. Please use "hyperlink-parser" instead!');
    deprecated('    https://www.npmjs.com/package/hyperlink-parser');
    deprecated('    ******************************************************************************');
